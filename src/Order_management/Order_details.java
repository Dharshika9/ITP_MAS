 ...
 public void showdate(){
  ...
  String x="Select";
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 80, 220, 30));
...
//update Order
        ...
        else if(PQ.length()>4 || isnum(PQ)==0) 
            {
            jTextField6.setText(null);
            jTextField6.setText(" ! Enter your valid mobile Number");
            }
        else{
            try {
        ...
        procode.setSelectedItem("Select");
...
//                String sql ="SELECT id FROM customer where id='"+Cid+"'  "; 
//                        pst = con.prepareStatement(sql);
//                        rs =pst.executeQuery();
//                        
//                      while(rs.next()){
                  ...
                  String sql1 ="SELECT * FROM customer  "; 
                        ...
                        while(rs.next()){
                          String  cus=rs.getString("id");
                            ...
                            if(CUS.equals(cus)){
                                showMessageDialog(null,"Customer is exist !", "Error", JOptionPane.ERROR_MESSAGE);
                                jTextField5.setText(null);}
                            }
                }
