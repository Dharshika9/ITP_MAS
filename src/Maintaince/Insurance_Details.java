...
//db connect    
    ...
    public Insurance_Details() {
        ...
        InsuranceCode.setText(function.getNextID("Insu_Code", "insurance", "I10", con));//primary key auto increment
    ...
    try{
     ...
     public void showdate(){
            ...
            RenewalDate.setText(s.format(d));
    ...
    private void initComponents() {
        ...
        RenewalDate = new javax.swing.JTextField();
        ...
        MachineID.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        MachineID.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MachineIDActionPerformed(evt);
            }
        });
        jPanel1.add(MachineID, new org.netbeans.lib.awtextra.AbsoluteConstraints(196, 157, 180, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 1090, 190));
        ...
        jLabel15.setText("<");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 20, -1));
        ...
        jPanel1.add(InsuranceCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 170, 20));

        RenewalDate.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        RenewalDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RenewalDateActionPerformed(evt);
            }
        });
        jPanel1.add(RenewalDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 130, -1));
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ...
        String ren_date = RenewalDate.getText();
        String company = CompanyRegNo.getText();
        String policy_num = PolicyNo.getText();
        String premium = Premium.getText();
      
         if(mid.isEmpty() || insu_value.isEmpty() || ren_date.isEmpty() || company.isEmpty() || policy_num.isEmpty() || premium.isEmpty()){
...
//            jTextField8.setText(null);
    ...
    private void InsuranceTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_InsuranceTableMouseClicked
       ...
       String ren_date    = InsuranceTable.getValueAt(r, 3).toString();
    ...
    private void RenewalDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RenewalDateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_RenewalDateActionPerformed
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        ...
        if(x==0)
        {
            ...
            String mid = MachineID.getText();
            String insu_value = InsuranceValue.getText();
//            String ren_date = jTextField1.getText();
            String company = CompanyRegNo.getText();
            String policy_num = PolicyNo.getText();
            String premium = Premium.getText();
            
          
            String sql = "UPDATE insurance SET  Insu_Code='"+insu_code+"' ,MID='"+mid+"' , Insu_Value='"+insu_value+"' , Company='"+company+"' , PolicyNo='"+policy_num+"' , Premium='"+premium+"' WHERE Insu_Code='"+insu_code+"'";
...
//            jTextField8.setText(null);
    ...
    private javax.swing.JTextField RenewalDate;
