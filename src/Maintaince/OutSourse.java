...
public class OutSourse extends javax.swing.JFrame {
    ...
    public OutSourse() {
        initComponents();
        showdate();
        OutsourseID.setText(function.getNextID("OSID", "outsourse", "OS10", con)); //primary key auto increment
   ...
   //only letters
    ...
    private void initComponents() {
        ...
        ReturnDate.setText("2017-08-08");
        ReturnDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ReturnDateActionPerformed(evt);
            }
        });
        jPanel1.add(ReturnDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, 110, -1));
        ...
        MachineType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select  Machine Type", "a", "b", "c", "d", "e" }));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 1100, 170));
        ...
        jPanel1.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 90, 100, 20));
        jPanel1.add(Month, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 40, -1));
        jPanel1.add(Day, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 40, -1));
        ...
        jPanel1.add(Year, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 240, 40, -1));
    ...
    private void jPanel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel13MouseClicked
        ...
        //String rentdate = RentedDate.getText();
        ...
        String rentdate= year+"-"+month+"-"+day;
         ...
         if(mid.isEmpty() || mtype.isEmpty() || year.isEmpty() || month.isEmpty() || day.isEmpty() || day.isEmpty() || rdate.isEmpty() || deposite.isEmpty() || charges.isEmpty()|| vendor.isEmpty() || address.isEmpty() || phone.isEmpty()){
        
            showMessageDialog(null,"Enter all essential data!", "Error", JOptionPane.ERROR_MESSAGE);
        }
         
          //only num validation
        else if(isnum(deposite)==0) {
            
            showMessageDialog(null,"Can't use letters in Deposite field");
        }
        
        //only num validation
         else if(isnum(charges)==0) {
            
            showMessageDialog(null,"Can't use letters in Charges field");
        }
         
         //only letters validation
        else if(isletters(vendor)==0)
         {
    ...
    private void OutsourceTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OutsourceTableMouseClicked
       ...
       String rentdate = OutsourceTable.getValueAt(r, 3).toString();
       String rdate = OutsourceTable.getValueAt(r, 4).toString();
