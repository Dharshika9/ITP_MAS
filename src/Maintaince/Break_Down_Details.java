...
public class Break_Down_Details extends javax.swing.JFrame {
    ...
    public Break_Down_Details() {
        initComponents();
        showdate();
        BreakdownID.setText(function.getNextID("BID", "breakdown", "BD10", con)); //primary key auto increment
    ...
    private void initComponents() {
        ...
        jPanel1.add(Date, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 250, 261, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 1100, 190));
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        ...
        if(mid.isEmpty() || eid.isEmpty() || email.isEmpty() || mtype.isEmpty() || description.isEmpty() || date.isEmpty()){
    ...
    private void BreakdownTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BreakdownTableMouseClicked
       ...
       String date= BreakdownTable.getValueAt(r, 6).toString();
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        ...
        if(x==0)
        {
            ...
            String sql = "UPDATE breakdown SET  MID='"+mid+"' ,EID='"+eid+"', email='"+email+"' , BID='"+bid+"' , Mtype='"+mtype+"' , description='"+description+"' , date='"+date+"' WHERE BID='"+bid+"'";
