...
public class machine_details extends javax.swing.JFrame {
  ...
  //db connect    
    ...
    public machine_details() {
        initComponents();
        showdate();
        MachineID.setText(function.getNextID("MID", "mdetails", "M10", con)); //primary key auto increment
    ...
    try{
     ...
     public void showdate(){
            ...
            RegistrationDate.setText(s.format(d));
    ...
    private void initComponents() {
        ...
        MachineType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Machine Type", "a", "b", "c", "d" }));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 430, 1110, 170));
        ...
        jPanel1.add(RegistrationDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 90, 140, -1));
    ...
    private void jPanel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel21MouseClicked
        ...
        if(x==0)
        {
             ...
             String regdate = RegistrationDate.getText();
...
//             jTextField5.setText(null);
    ...
    private void jPanel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel13MouseClicked
        ...
        //isempty
        if(mname.isEmpty() || mtype.isEmpty() || model.isEmpty() || description.isEmpty() || regdate.isEmpty() || vendor.isEmpty() || cname.isEmpty() ||  cid.isEmpty()){
        
            JOptionPane.showMessageDialog(null,"Enter all essential data!", "Error", JOptionPane.ERROR_MESSAGE);
        }
        
              //only letters validation
        else if(isletters(mname)==0)
         {
    ...
    private void MachineTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MachineTableMouseClicked
       ...
       String regdate= MachineTable.getValueAt(r, 5).toString();
    ...
    private void MachineSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MachineSearchKeyReleased
        ...
        try {
            ...
            String sql ="SELECT mid,mtype FROM mdetails where mid LIKE'"+search+"%' OR mtype LIKE '"+search+"%' ";
            pst = con.prepareStatement(sql);
    ...
    private void jPanel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel6MouseClicked
        Insurance_Details id;
        id = new Insurance_Details();
        id.setVisible(true); 
