...
public class Dry_foods extends javax.swing.JFrame {
    ...
    public void tableload1(){
        ...
        try{
            ...
            String sql = "SELECT FoodID as 'Dryf Id',FoodName as 'Dryfood Name',Quantity,LastDate FROM Food where FoodID like 'd%'";
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(871, 424));
    ...
    private void DeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteMouseClicked
        ...
        if(x==0)
        {
            ...
            try {
                ...
                tableload1();
                jLabel2.setText(Func.getNextID("FoodID", "Food", "D", conn));
    ...
    private void SearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchMouseClicked
        ...
        {
            String sql = "SELECT * FROM Food WHERE FoodName LIKE '%"+search+"%' and FoodID LIKE 'd%'";
