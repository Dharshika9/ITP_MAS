...
public class OutofStock extends javax.swing.JFrame {
    ...
    public void tableload1(){
        ...
        try {
            String sql = "Select FoodName,Quantity FROM Food where FoodId like 'v%' and Quantity<40";
...
//                  jTable1.setModel(DbUtils.resultSetToTableModel(rst1));
        ...
        try {
            String sql = "Select FoodName,Quantity FROM Food where FoodId like 'd%' and Quantity<10";
            pst1 = conn.prepareStatement(sql);
            rst1 = pst1.executeQuery();
...
//                  jTable1.setModel(DbUtils.resultSetToTableModel(rst1));
        ...
        try {
            String sql = "Select FoodName,Quantity FROM Food where FoodId like 'm%' and Quantity<10";
            pst1 = conn.prepareStatement(sql);
            rst1 = pst1.executeQuery();
...
//                  jTable1.setModel(DbUtils.resultSetToTableModel(rst1));
        ...
        try {
            String sql = "Select FoodName,Quantity FROM Food where FoodId like 'o%' and Quantity<10";
            pst1 = conn.prepareStatement(sql);
            rst1 = pst1.executeQuery();
...
//                  jTable1.setModel(DbUtils.resultSetToTableModel(rst1));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 200, 380));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 110, 200, 380));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 110, 200, 380));
        ...
        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 110, 200, 380));
