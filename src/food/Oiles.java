...
public class Oiles extends javax.swing.JFrame {
    ...
    public void tableload1(){
        ...
        try{
            ...
            String sql = "SELECT FoodID as 'Oil ID',FoodName as 'Oil Name',Quantity,LastDate FROM Food where FoodID like 'o%'";
    ...
    private void ADDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ADDMouseClicked
        ...
        if(found(v_name)==0)
        {
            ...
            try{
                ...
                tableload1();
                jLabel2.setText(Func.getNextID("FoodID", "Food", "O", conn));
                jTextField2.setText(null);
                jTextField1.setText(null);
    ...
    private void DeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteMouseClicked
        ...
        if(x==0)
        {
            ...
            String sql = "DELETE from Food WHERE FoodID='"+v_id+"'";
    ...
    private void SearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchMouseClicked
        ...
        {
            String sql = "SELECT * FROM Food WHERE FoodName LIKE '%"+search+"%' and FoodID LIKE 'o%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Oiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
