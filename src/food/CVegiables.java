 ...
 */
public class CVegiables extends javax.swing.JFrame {
    ...
    public void tableload1(){
        ...
        try{
            ...
            String sql = "SELECT FoodName as 'Vegi Name',Quantity FROM Food where FoodID like 'v%'";
...
//        quantity.setText(null);
    ...
    private void SearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchMouseClicked
        ...
        {
        String sql = "SELECT FoodName,Quantity FROM Food WHERE FoodName LIKE '%"+search+"%' and FoodID LIKE 'v%'";
...
//        jLabel5.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CVegiables.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CVegiables().setVisible(true);
            }
        });
    }
