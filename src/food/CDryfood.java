 ...
 */
public class CDryfood extends javax.swing.JFrame {
    ...
    public void tableload1(){
        ...
        try{
            ...
            String sql = "SELECT FoodName as 'Vegi Name',Quantity FROM Food where FoodID like 'd%'";
    ...
    private void SearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SearchMouseClicked
        ...
        if(search.isEmpty())
        {
            showMessageDialog(null,"Eneter dryfood Name");
        }
        else
        {
            String sql = "SELECT FoodName,Quantity FROM Food WHERE FoodName LIKE '%"+search+"%' and FoodID LIKE 'd%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CDryfood.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
